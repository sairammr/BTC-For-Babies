...
export default function QuestsPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 pb-24">
      <PageTitle title="QUESTS" icon="/images/pixel-quest.png" />
        ...
        {activeTab === "todo" ? (
          <div className="grid gap-4 md:grid-cols-2">
            {tasks.length > 0 ? (
              ...
              <div className="col-span-2 rounded-lg border-2 border-dashed border-purple-200 p-8 text-center">
                <img src="/images/pixel-empty.png" alt="No tasks" className="mx-auto mb-4 h-24 w-24" />
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {completedTasks.length > 0 ? (
              ...
              <div className="col-span-2 rounded-lg border-2 border-dashed border-purple-200 p-8 text-center">
                <img src="/images/pixel-empty.png" alt="No completed tasks" className="mx-auto mb-4 h-24 w-24" />
